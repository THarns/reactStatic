...
const Navigation = () => {
  ...
  useEffect(() => {
    ...
    <button type='button' className="toggle_dark_btn" onClick={toggle} style={{backgroundColor: 'transparent', color: theme.color, backgroundImage:theme.btnImg, outline:'none', zIndex:999}}><p>{theme.msg}</p></button>
      </div>
    );
}
